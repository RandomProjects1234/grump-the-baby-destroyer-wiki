...
DESCRIPTIONS = {
    ...
    'minigames': "Jerry's laps, dumbbells and jump rope, Meredith's lunch rhythm game, and the nurse's office plaster game, controls and rewards.",
    ...
    'food': "Your own hunger, food items, and where to find them.",
    'hiding': "Every hiding spot rule: peeking, taping lockers shut, and how Bob and Grump check them.",
    'toddlers': "The other children: injuries, the nurse's office, carrying, calming, safe spots, and being taken.",
